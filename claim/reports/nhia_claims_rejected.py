...
def nhia_claims_rejected_query(user, start_date: None, end_date: None, **kwargs):
    ...
    for claim in claims:
        ...
        new_data_element = {
            ...
            "rejected_amount": claim["amount"],
            "total_rejected": claim["total"],
        }
